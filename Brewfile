...
# replaced(asdf): cask "adoptopenjdk8"
# replaced(asdf): brew "awscli"
# replaced(asdf): brew "cloud_sql_proxy"
# replaced(asdf): brew "go"
# replaced(asdf): brew "kops"
# replaced(asdf): brew "kotlin"
# replaced(asdf): brew "krew"
# replaced(asdf): brew "kubectx"
# replaced(asdf): brew "kubie"
# replaced(asdf): brew "openjdk"
# replaced(asdf): brew "openjdk@11"
# replaced(asdf): brew "python@3.10"
# replaced(asdf): brew "python@3.9"
# replaced(asdf): brew "ruby"
# replaced(asdf): brew "skaffold"
# replaced(asdf): brew "stern"
# replaced(asdf): brew "velero"
# replaced(asdf): cask "adoptopenjdk"
# replaced(asdf): cask "graalvm-ce-lts-java11"
...
# deprecated: mas "TickTick", id: 966085870
